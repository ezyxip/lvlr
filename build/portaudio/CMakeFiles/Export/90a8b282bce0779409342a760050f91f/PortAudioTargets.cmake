...
foreach(_cmake_expected_target IN ITEMS PortAudio::PortAudio)
...
# Create imported target PortAudio::PortAudio
add_library(PortAudio::PortAudio STATIC IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/PortAudioTargets-*.cmake")
